...
void Estoque::adicionarTV()
{
    ...
    for (int i = 0; i < notebooks.size(); i++)
    {
        ...
        {
            codigo = notebooks[i].getCodigo() + 1;
        }
    }
                ...
                if (codigo != 0)
                {
                    ...
                    for (int i = 0; i < notebooks.size(); i++)
                    {
                        if (notebooks[i].getCodigo() == codigo)
                        {
                            ...
                            if (escolha == 's')
                            {
                                cout << "Digite a quantidade desejada (" << notebooks[i].getQuantidade() << " disp): " << endl;
                                cin >> quantidade;
                                cout << endl;
                                if (quantidade > notebooks[i].getQuantidade())
                                {
                ...
                if (codigo != 0)
                {
                    ...
                    for (int i = 0; i < tvs.size(); i++)
                    {
                        if (tvs[i].getCodigo() == codigo)
                        {
                            ...
                            if (escolha == 's')
                            {
                                cout << "Digite a quantidade desejada (" << tvs[i].getQuantidade() << " disp): " << endl;
                                cin >> quantidade;
                                cout << endl;
                                if (quantidade > tvs[i].getQuantidade())
                                {
